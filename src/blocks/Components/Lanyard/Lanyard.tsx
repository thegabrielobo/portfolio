...
// Gabriel's custom assets
const CARD_GLB = 'https://res.cloudinary.com/glovooker/image/upload/v1714363344/portfolio/custom-tag.glb';
const BAND_TEXTURE = 'https://res.cloudinary.com/glovooker/image/upload/v1714362722/portfolio/band.jpg';
